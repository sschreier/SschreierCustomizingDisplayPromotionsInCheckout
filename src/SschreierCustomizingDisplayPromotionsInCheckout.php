...
namespace Sschreier\CustomizingDisplayPromotionsInCheckout;
...
class SschreierCustomizingDisplayPromotionsInCheckout extends Plugin
{
    const CUSTOM_FIELD_SET_TECHNICAL_NAME = 'sschreier_promotion';
